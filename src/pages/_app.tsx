...
function MyApp({ Component, pageProps }) {
	...
	const supabase = createClient("https://ldmvmkkhldzpwfryrkvq.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoiYW5vbiIsImlhdCI6MTYzNDA3OTMwNSwiZXhwIjoxOTQ5NjU1MzA1fQ.AEoeEKRFe45nI-ZgMJLuUdqoP8Ut-Ii88CSHQAzyiLA");
