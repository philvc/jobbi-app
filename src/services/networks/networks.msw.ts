...
export const getGetNetworksBySearchIdMock = () => ([...Array(faker.datatype.number({min: 1, max: 10}))].map(() => ({description: faker.random.word(), email: faker.random.word(), firstName: faker.random.word(), id: faker.datatype.number(), lastName: faker.random.word(), link: faker.random.word(), phoneNumber: faker.random.word(), searchId: faker.datatype.number(), userId: faker.datatype.number()})))

export const getAddNetworkMock = () => ({description: faker.random.word(), email: (() => faker.internet.email())(), firstName: (() => faker.name.firstName())(), id: faker.datatype.number(), lastName: (() => faker.name.lastName())(), link: faker.random.word(), phoneNumber: (() => faker.phone.phoneNumber("+32494######"))(), searchId: faker.datatype.number(), userId: faker.datatype.number()})

export const getGetNetworkByIdMock = () => ({description: faker.random.word(), email: (() => faker.internet.email())(), firstName: (() => faker.name.firstName())(), id: faker.datatype.number(), lastName: (() => faker.name.lastName())(), link: faker.random.word(), phoneNumber: (() => faker.phone.phoneNumber("+32494######"))(), searchId: faker.datatype.number(), userId: faker.datatype.number()})
